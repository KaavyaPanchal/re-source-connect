  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-lg flex-col justify-center gap-6 p-8">
      ...
      <div className="panel space-y-3 p-6">
        <h1 className="text-xl font-semibold tracking-tight">Connect {clientName} to RE:SOURCE</h1>
        <p className="text-sm text-muted-foreground">
          {clientName} will be able to read the surplus listings, needs and transfers you can see, and
          publish needs for your organizations — acting as you.
        </p>
        {error && (
